 ...
 * @author achma
 */
public class CetakBuktiPenerimaan extends javax.swing.JInternalFrame {

    /**
     * Creates new form CetakBuktiPenerimaan
     */
    
    Connection connection;
    java.sql.Statement stat,stat1,stat2;
    ResultSet rs;
    String total, sql, sql1, sql2, nodaftar;
    
    public CetakBuktiPenerimaan(String nodaf) {
         try {
            initComponents();
            ...
            Logger.getLogger(CetakKartuSiswa.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void Process() throws FileNotFoundException
    {
        try{
            ...
            Map prs = new HashMap();            
            InputStream filePath = getClass().getResourceAsStream("/report/BuktiPenerimaan.jrxml");
            ...
            sql = "SELECT\n" +
                    ...
                    "pendaftaran.nodaftar = '"+nodaftar+"' AND\n" +
