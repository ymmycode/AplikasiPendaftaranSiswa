 ...
 * @author achma
 */
public class CetakLaporanDataPembayaran extends javax.swing.JInternalFrame {

    /**
     * Creates new form CetakLaporanDataPembayaran
     */
    ...
    public CetakLaporanDataPembayaran(String month, String year) {
         try {
            initComponents();
            ...
            Logger.getLogger(CetakLaporanDataPembayaran.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void Process() throws FileNotFoundException
    {
        try{
            ...
            Map prs = new HashMap();            
            InputStream filePath = getClass().getResourceAsStream("/report/LaporanDataPembayaran.jrxml");
            ...
            sql = "SELECT\n" +
                    ...
                    "pembayaran\n" +
                    "WHERE\n" +
                    "pembayaran.tglpembayaran LIKE '%"+nowTime+"%'";
