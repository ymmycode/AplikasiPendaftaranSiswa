...
public class CetakLaporanDataPenerimaan extends javax.swing.JInternalFrame {

    /**
     * Creates new form LaporanDataPenerimaan
     * @param month
     * @param year
     */
    ...
    public CetakLaporanDataPenerimaan(String month, String year) {
        try {
            initComponents();
            ...
            Logger.getLogger(CetakLaporanDataPenerimaan.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void Process() throws FileNotFoundException
    {
        try{
            ...
            Map prs = new HashMap();            
            InputStream filePath = getClass().getResourceAsStream("/report/LaporanPenerimaan.jrxml");
