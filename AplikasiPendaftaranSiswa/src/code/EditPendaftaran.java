 ...
 * @author achma
 */
public class EditPendaftaran extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("FORM PENGUBAHAN DATA PENDAFTARAN");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            ...
            Logger.getLogger(EditPendaftaran.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        String ttl = jTable1.getModel().getValueAt(row, 4).toString();
        String agama = jTable1.getModel().getValueAt(row, 5).toString();
        String notelp = jTable1.getModel().getValueAt(row, 6).toString();
        String alamat = jTable1.getModel().getValueAt(row, 7).toString();
        
        jLabel15.setText(nodaftar);
        jLabel16.setText(nodaftar);
        jTextField2.setText(nama);
        jComboBox4.setSelectedItem(kelamin);
        jTextField4.setText(namawali);
        jTextField5.setText(ttl); 
        jTextField7.setText(agama);
