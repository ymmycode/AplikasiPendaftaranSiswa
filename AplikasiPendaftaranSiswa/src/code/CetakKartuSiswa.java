 ...
 * @author achma
 */
public class CetakKartuSiswa extends javax.swing.JInternalFrame {

    /**
     * Creates new form CetakKartuSiswa
     */
    
    Connection connection;
    java.sql.Statement stat,stat1,stat2;
    ResultSet rs;
    String total, sql, sql1, sql2, nomorInduk;
    
    public CetakKartuSiswa(String nis) {
         try {
            initComponents();
    ...
    private void Process() throws FileNotFoundException
    {
        try{
            ...
            Map prs = new HashMap();            
            InputStream filePath = getClass().getResourceAsStream("/report/KartuSiswa.jrxml");
